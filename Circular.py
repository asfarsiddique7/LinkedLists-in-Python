# Roll no: F1F18BSCS0001
# Name: Muhammad Asfar Siddique
# Class: BSCS 5A
...
def main():
    ...
    myList.add(8)
    myList.add(9)
    print("Search 9", myList.find(9))
    print("Search 12", myList.find(12))
    ...
    print("\n\n\nsize=" + str(myList.get_size()))
    myList.print_list()
    myList.remove(8)
    print("\n\nsize=" + str(myList.get_size()))
    print("\n\nRemove 15", myList.remove(15))
    print("\n\nsize=" + str(myList.get_size()))
    myList.remove(9)  # delete root node
    myList.print_list()
